...
const CTA = () => {
  return (
    <section className="bg-gradient-to-r from-screenwise-teal-dark to-screenwise-teal py-20">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button className="bg-white text-screenwise-teal hover:bg-screenwise-light rounded-full px-8 py-6 text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
