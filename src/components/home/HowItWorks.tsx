...
const HowItWorks = () => {
  return <section className="section bg-screenwise-gray">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-t-4 border-screenwise-teal">
            ...
            <p className="text-gray-600">Guides families through structured home meals using therapist-assigned plans. Automatically tracks bite counts, food volume, disruptive behaviors, engagement, and pacing — while delivering rewards via preferred digital content such as audiobooks, games, puzzles, Youtube Kids, and more.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-t-4 border-screenwise-teal">
            ...
            <p className="text-gray-600">Enables therapists to assign interventions, adjust therapy and reinforcement settings, and monitor detailed mealtime metrics in real time. Data visualizations highlight trends and progress, allowing therapists to make informed adjustments to the therapy plan.</p>
          </div>
        </div>

        <div className="text-center mt-12 max-w-3xl mx-auto">
          <p className="text-lg text-gray-700 font-medium px-6 py-4 bg-screenwise-light bg-opacity-50 rounded-xl inline-block">This two-way system creates a continuous therapy loop, improving outcomes and reducing reliance on caregiver-reported manual data.</p>
        </div>
      </div>
    </section>;
};
