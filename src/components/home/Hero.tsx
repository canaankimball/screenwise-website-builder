...
const Hero = () => {
  return <section className="bg-gradient-to-br from-white to-screenwise-light pt-20 pb-16 md:pt-32 md:pb-24">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
            ...
            animationDelay: '0.2s'
          }}>Designed for feeding therapists, Screenwise Eating brings structure and real-time data to at-home meals, so you can assign customized feeding plans, support caregivers, and access accurate home data—all in one place.</p>
          ...
          animationDelay: '0.6s'
            ...
            <img src="https://images.unsplash.com/photo-1649972904349-6e44c42644a7?auto=format&fit=crop&q=80&w=600" alt="Person using ScreenWise Eating app" className="rounded-2xl shadow-xl w-full relative z-10" />
          </div>
        </div>
      </div>
    </section>;
