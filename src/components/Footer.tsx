        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/people/Screenwise-Yumeats/61565989516609/" target="_blank" rel="noopener noreferrer" className="hover:text-screenwise-teal transition-colors">
                <Facebook size={20} />
              </a>
              <a href="https://www.tiktok.com/@screenwise_yumeats" target="_blank" rel="noopener noreferrer" className="hover:text-screenwise-teal transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/screenwise_yumeats/" target="_blank" rel="noopener noreferrer" className="hover:text-screenwise-teal transition-colors">
                <Instagram size={20} />
              </a>
              <a href="https://www.linkedin.com/company/103432499/admin/dashboard/" target="_blank" rel="noopener noreferrer" className="hover:text-screenwise-teal transition-colors">
                <Linkedin size={20} />
              </a>
            </div>
          </div>
