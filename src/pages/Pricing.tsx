...
const PricingTier = ({ 
  ...
  <div className={`flex flex-col rounded-2xl p-6 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${
    isFeatured ? 'border-2 border-primary bg-white relative' : 'bg-white'
  }`}>
    {isFeatured && (
    ...
    <Button 
      className={
        isFeatured 
          ? "mt-auto bg-screenwise-teal hover:bg-screenwise-teal-dark text-white rounded-full py-6" 
          : "mt-auto bg-white border border-screenwise-navy text-screenwise-navy hover:bg-screenwise-light rounded-full py-6"
      }
    >
      {ctaText}
    </Button>
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <PricingTier 
              title="Free Trial" 
              price="Free" 
              clients="1 client profile, 1 therapist login"
              features={[
                "Full access to YumEats app",
                "Basic meal logging",
                "Video incentives",
                "14-day trial period"
              ]}
      ...
      <section className="py-16 bg-screenwise-light">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-screenwise-navy mb-4">Need more than 20 clients?</h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            We offer custom pricing for clinics, schools, and ABA companies looking to empower multiple therapists.
          </p>
          <Button className="bg-screenwise-teal text-white hover:bg-screenwise-teal-dark rounded-full px-8 py-6">
            Contact Us
          </Button>
