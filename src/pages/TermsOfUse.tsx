              ...
              <div className="space-y-8">
                <div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    These Terms of Use ("Terms" or "Terms of Use") constitute an agreement between you ("you" or the "user") and Screenwise Eating, LLC and its affiliates, subsidiaries or assigns (collectively, "YumEats," "we," "us" or "our"). This website (the "Site") is owned and operated by YumEats. Access and use of this Site and our services provided through the Site, application, and offline (together, the "Services") are provided by YumEats to you on condition that you accept these Terms of Use. By accessing or using the Services, you signify that you have read, understand, and agree to be bound by these Terms of Use. If you do not agree to accept these Terms of Use, you may not access or use the Services.
                  </p>
                  <p className="text-gray-700 leading-relaxed mb-4">
