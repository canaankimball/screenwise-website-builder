            ...
            <div className="space-y-8 text-gray-700 leading-relaxed">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4 ml-4">
                  ...
                  <p>
                    <strong>Cookies and Personalized Advertising.</strong> You may stop or restrict the placement of cookies and tracking technologies on your device or remove them by adjusting your preferences as your browser or device permits. However, if you adjust your preferences, our Services may not work properly. Please note that cookie-based opt-outs are not effective on mobile applications. However, you may opt out of personalized advertisements on some mobile applications by following the instructions provided by <Link to="https://support.google.com/googleplay/android-developer/answer/6048248?hl=en" className="text-blue-600 hover:text-blue-800 underline">Android</Link> or <Link to="https://support.apple.com/en-us/105131" className="text-blue-600 hover:text-blue-800 underline">IOS</Link>. You can find out more about cookies and how to manage them by visiting <Link to="https://ico.org.uk/for-the-public/online/cookies/" className="text-blue-600 hover:text-blue-800 underline">https://ico.org.uk/for-the-public/online/cookies/</Link>.
                  </p>
                </div>
              </div>
