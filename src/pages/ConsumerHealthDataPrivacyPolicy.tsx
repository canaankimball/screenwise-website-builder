            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    If your request to exercise a right under MHMD, SB370, or CDPA is denied, you may appeal that decision by contacting us using the information below. If your appeal is unsuccessful, you may raise a concern or lodge a complaint with the <a href="http://www.atg.wa.gov/file-complaint" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">Washington State Attorney General</a>, the <a href="https://ag.nv.gov/Complaints/CSU_Complaints___FAQ/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">Nevada State Attorney General</a>, or the <a href="https://portal.ct.gov/ag/contact-the-attorney-generals-office/contact-the-attorney-generals-office" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">Connecticut State Attorney General</a>.
                  </p>
                </div>
