        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            <p className="text-gray-600 leading-relaxed">
              This is placeholder text for the Consumer Health Data Privacy Policy page. You can paste your actual Consumer Health Data Privacy Policy document content here. 
